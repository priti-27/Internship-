...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2020 at 05:50 PM
...
CREATE TABLE `vcard` (
  ...
  `vc_fullname` varchar(45) CHARACTER SET latin1 NOT NULL,
  `vc_phone` varchar(14) CHARACTER SET latin1 NOT NULL,
  `vc_altphone` varchar(14) CHARACTER SET latin1 NOT NULL,
  `vc_whatsapp` varchar(14) CHARACTER SET latin1 NOT NULL,
  `vc_email` varchar(65) CHARACTER SET latin1 NOT NULL,
  `vc_bizaddress` text CHARACTER SET latin1 NOT NULL,
  `vc_fbusername` varchar(35) CHARACTER SET latin1 NOT NULL,
  `vc_instausername` varchar(35) CHARACTER SET latin1 NOT NULL,
  `vc_twitter` varchar(35) CHARACTER SET latin1 NOT NULL,
  `vc_mapurl` text CHARACTER SET latin1 NOT NULL,
